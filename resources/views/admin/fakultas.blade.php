                        ...
                        <div class="data-tab">
                            <table datatable="ng" class="table table-bordered">
                                ...
                                <tbody style="font-size: 12px">
                                    <tr class="text-center" ng-repeat="row in datafakultas">
                                        <td>@{{ $index + 1 }}</td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="text" class="form-control fakultas" placeholder="Kode Fakultas"
                        <p style="font-size: 12px;"><small style="color: red"> * </small>Wajib Di Isi</p>

                        <input type="text" class="form-control fakultas" placeholder="Nama Fakultas">
                        <p style="font-size: 12px;"><small style="color: red"> * </small> Wajib Di Isi</p>
                    </div>

                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" ng-hide="aksi" ng-click="saveFakultas()"><i class="ti-save"></i> SIMPAN</button>
                        <button type="button" class="btn btn-success" ng-show="aksi" ng-click="updateFakultas()"><i class="ti-save"></i> PERBARUI</button>
...
@section('javascript')
    ...
    <script src="{{ asset('assets/js/admin/fakultas/app.js') }}"></script>
    <script src="{{ asset('assets/js/admin/fakultas/service.js') }}"></script>
@endsection
