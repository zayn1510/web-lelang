...
app.controller("homeController", function ($scope, service) {
    ...
    fun.editData = (row) => {
        ...
        periode[3].value = row.tgl_mulai;
        periode[4].value = row.tgl_selesai;
        id_periode = row.id;
        fun.aksi = true;
    }
    ...
    fun.savePeriode = () => {
        ...
        var dataPeriode = {
            ...
            tgl_mulai: periode[3].value,
            tgl_selesai: periode[4].value,
            status: periode[5].value,
            status_pendaftaran: periode[6].value
        };
    ...
    fun.updateStatusPendaftaran = (row, status) => {
        var dataPeriode = {
            tahun_akademik: row.tahunakademik,
            angkatan: row.angkatan,
            tgl_akademik: row.tanggal,
