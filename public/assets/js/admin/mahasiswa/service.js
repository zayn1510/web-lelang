app.service("service", ["$http", function($http) {
    ...
    this.checkDuplicate= function(obj,callback) {
        $http({
            url: URL_API+"mahasiswa/check-duplicate",
            method: "POST",
            data:obj
    ...
    this.insertExcel= function(obj,callback) {
        $http({
            url: URL_API+"mahasiswa/insert-excel",
            method: "POST",
            data:obj
