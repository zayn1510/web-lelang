...
class LoginRepository
{
    ...
    public static function login_akun(LoginRequest $loginRequest): JsonResponse
    {
        ...
        try {
            ...
            if ($check) {
                return response()->json(["message" => "login has success", "success" => true, "id_pengguna" => $id_pengguna], 200);
            }
    ...
    public static function detail_akun($id)
    {
        ...
        try {
            if (is_int($id)) {
                return response()->json(["message" => "Value Must Be Number", "success" => false], 200);
            }
    ...
    public static function deletePengguna(int $id)
    {
        try {
            User::findOrFail($id)->delete();
            return response()->json(["message" => "Success", "success" => true], 200);
        } catch (ModelNotFoundException $th) {
            return response()->json(["message" => "Invalid ID Pengguna", "success" => false], 404);
